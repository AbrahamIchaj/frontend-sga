...
export class DespachosAnualesComponent implements OnInit {
  ...
  readonly filasTabla = computed<TablaDespachosFila[]>(() => {
  ...
  cargarDatos(): void {
    ...
    this.reportesService.obtenerDespachosAnuales(filtros).subscribe({
      next: (data) => {
      ...
      error: (error) => {
        ...
        this.sweetAlert.error(
          'Error al cargar los despachos anuales',
